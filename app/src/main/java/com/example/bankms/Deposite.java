...
public class Deposite extends AppCompatActivity {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        if (amount <= currentBalance) {
                            ...
                            Toast.makeText(Deposite.this, "Deposite successful", Toast.LENGTH_SHORT).show();

                            // Update the displayed balance
                            updateBalance();
                        } else {
                            Toast.makeText(Deposite.this, "Insufficient balance", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
    ...
    private void saveTransaction(double amount) {
        ...
        Transaction1 transaction = new Transaction1(transactionId, uid, "Deposit", amount);
